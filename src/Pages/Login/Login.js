...
const Login = () => {
    ...
    return (
        <div className="w-full max-w-md p-8 my-4 space-y-3 rounded-xl border dark:bg-gray-900 dark:text-gray-100 mx-auto">
            ...
            <form onSubmit={handleSubmit(handleLogin)} novalidate="" action="" className="space-y-6 ng-untouched ng-pristine ng-valid">
                ...
                <div className="space-y-1 text-sm">
                    ...
                    <input {...register("password", { required: "Password Address is required", minLength: { value: 6, message: 'Passwor must be 6 characters or longer' } })} type="password" name="password" id="password" placeholder="Password" className="w-full px-4 py-3 rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-violet-400 input input-bordered" />
